...
function parseExecutionMetadata(value: unknown): AnalysisExecutionMetadata | null {
  ...
  if (typeof value === 'string') { try { return JSON.parse(value) as AnalysisExecutionMetadata } catch { return null } }
  return typeof value === 'object' ? value as AnalysisExecutionMetadata : null
}
