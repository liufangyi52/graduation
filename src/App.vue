...
import MeetingImportPage from './components/MeetingImportPage.vue'
  ...
  <div class="app-shell" :class="{ dark }">
    ...
    <main class="main-canvas" :class="{ expanded: !sidebarOpen }">
      ...
      <div class="content">
        ...
        <MeetingImportPage v-else-if="currentPage === 'meetings'" :token="token" :projects="data.projects" @submitted="meetings.load(); service.loadCalendarEvents()" @notice="flash" />
