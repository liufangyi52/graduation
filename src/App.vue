...
import { createWorkspaceService, type CalendarEvent, type Project, type RiskLevel, type Task, type TaskState } from './services/workspaceService'
import { canManageProjectBusiness, createAuthService, roleLabels, type ManagedUser, type UserAccount, type UserRole } from './services/authService'
    ...
    <main class="main-canvas" :class="{ expanded: !sidebarOpen }">
      ...
      <div class="content">
        ...
        <section v-else-if="currentPage === 'dashboard' && user.role === 'admin'" class="page-section">
          <div class="welcome-row"><div><p class="eyebrow">SYSTEM ADMINISTRATION</p><h2>Administrator workspace</h2><p class="muted">Manage accounts, system settings, and audit records.</p></div><button class="primary-button" @click="navigate('/users')"><Users :size="16" />账号管理</button></div>
        </section>
